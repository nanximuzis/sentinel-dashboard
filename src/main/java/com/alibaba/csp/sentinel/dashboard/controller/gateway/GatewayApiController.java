...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.GetWayApiNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.GetWayApiNacosPublisher;
...
public class GatewayApiController {
    ...
    private GetWayApiNacosProvider ruleProvider;

    //添加我们自己写的 publisher
    @Autowired
    @Qualifier("getWayApiNacosPublisher")
    private GetWayApiNacosPublisher rulePublisher;
    ...
    public Result<List<ApiDefinitionEntity>> queryApis(String app, String ip, Integer port) {
        ...
        try {
            ...
            //sentinelApiClient.fetchApis(app, ip, port).get();
